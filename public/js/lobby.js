...
const UNITS_DATA = [
  { id:'pietaille',      name:'Piétaille',      category:'Infanterie', cost:400,  vitality:180, morale:6,  attack:10, power:8,  defense:10, armor:2, intimidation:2, speed:3, range:1, bonus:"+1 de moral par tour lorsque l'unité se trouve dans la troupe du général." },
  { id:'soldats',        name:'Soldats',        category:'Infanterie', cost:600,  vitality:140, morale:10, attack:14, power:12, defense:10, armor:4, intimidation:3, speed:2, range:1, bonus:"Après un combat si l'unité ennemie est laissée avec 3 de vitalité ou moins, elle est détruite." },
  { id:'phalange',       name:'Phalange',       category:'Infanterie', cost:700,  vitality:140, morale:10, attack:12, power:8,  defense:15, armor:6, intimidation:2, speed:3, range:1, bonus:"La phalange peut faire un test de défense contre les unités de tireur. Si elle réussit, elle ignore la puissance ennemie." },
  { id:'lancier',        name:'Lancier',        category:'Infanterie', cost:700,  vitality:140, morale:10, attack:10, power:10, defense:8,  armor:3, intimidation:3, speed:3, range:1, bonus:"+3 attaque et défense contre les unités à cheval et les chars." },
  { id:'espion',         name:'Espion',         category:'Infanterie', cost:600,  vitality:80,  morale:10, attack:12, power:8,  defense:10, armor:2, intimidation:2, speed:4, range:1, bonus:"Peut détruire une infrastructure pour 2 de vitesse." },
  { id:'assassin',       name:'Assassin',       category:'Infanterie', cost:800,  vitality:100, morale:10, attack:16, power:10, defense:10, armor:2, intimidation:4, speed:4, range:1, bonus:"Avantage sur le premier jet d'attaque par jour. Peut disparaître si aucun ennemi à moins de 600m." },
  { id:'cavalier_leger', name:'Cavalier Léger', category:'Chevaux',    cost:900,  vitality:100, morale:10, attack:14, power:10, defense:7,  armor:2, intimidation:3, speed:6, range:1, bonus:"+1 de vitesse si l'unité n'est pas engagée." },
  { id:'cavalier_lourd', name:'Cavalier Lourd', category:'Chevaux',    cost:1200, vitality:80,  morale:14, attack:16, power:12, defense:8,  armor:4, intimidation:6, speed:5, range:1, bonus:"+1 de puissance et d'intimidation lors d'une charge." },
  { id:'archer',         name:'Archer',         category:'Tireurs',    cost:600,  vitality:140, morale:8,  attack:10, power:8,  defense:5,  armor:2, intimidation:2, speed:3, range:3, bonus:"Attaque à 300m. L'unité attaquée ne fait pas de test de défense." },
  { id:'archer_elite',   name:"Archer d'Élite", category:'Tireurs',    cost:900,  vitality:120, morale:10, attack:12, power:10, defense:6,  armor:2, intimidation:4, speed:3, range:5, bonus:"Attaque à 500m. L'unité attaquée ne fait pas de test de défense." },
  { id:'batisseurs',     name:'Bâtisseurs',     category:'Chars',      cost:1000, vitality:100, morale:8,  attack:8,  power:8,  defense:8,  armor:4, intimidation:2, speed:2, range:1, bonus:"Pour 2 vitesse, peut construire une barrière, un cheval de frise, une échelle, un pont ou brûler une tuile inflammable adjacente." },
  { id:'char',           name:'Char',           category:'Chars',      cost:1600, vitality:80,  morale:10, attack:16, power:14, defense:8,  armor:6, intimidation:5, speed:5, range:1, bonus:"Peut attaquer 2 unités simultanément si les 3 sont alignées. Traverse les unités lorsque c'est possible." },
];
