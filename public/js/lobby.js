...
const UNITS_DATA = [
  { id:'pietaille',      name:'Piétaille',      category:'Infanterie', cost:400,  vitality:300, morale:150, attack:6,  power:5,  defense:8,  armor:5,  intimidation:1,  speed:3, range:1, bonus:"+1 de moral par tour lorsque l'unité se trouve dans la troupe du général." },
  { id:'soldats',        name:'Soldats',        category:'Infanterie', cost:600,  vitality:240, morale:300, attack:10, power:10, defense:10, armor:10, intimidation:3,  speed:2, range:1, bonus:"Après un combat si l'unité ennemie est laissée avec 3 de vitalité ou moins, elle est détruite." },
  { id:'phalange',       name:'Phalange',       category:'Infanterie', cost:700,  vitality:250, morale:300, attack:9,  power:8,  defense:18, armor:22, intimidation:3,  speed:2, range:1, bonus:"La phalange peut faire un test de défense contre les unités de tireur. Si elle réussit, elle ignore la puissance ennemie." },
  { id:'lancier',        name:'Lancier',        category:'Infanterie', cost:700,  vitality:240, morale:300, attack:9,  power:10, defense:14, armor:11, intimidation:3,  speed:3, range:1, bonus:"+3 attaque et défense contre les unités à cheval et les chars." },
  { id:'espion',         name:'Espion',         category:'Infanterie', cost:600,  vitality:270, morale:240, attack:7,  power:6,  defense:9,  armor:7,  intimidation:2,  speed:4, range:1, bonus:"Peut détruire une infrastructure pour 2 de vitesse." },
  ...
  { id:'cavalier_leger', name:'Cavalier Léger', category:'Chevaux',    cost:900,  vitality:170, morale:300, attack:12, power:14, defense:6,  armor:8,  intimidation:4,  speed:6, range:1, bonus:"+1 de vitesse si l'unité n'est pas engagée." },
  { id:'cavalier_lourd', name:'Cavalier Lourd', category:'Chevaux',    cost:1200, vitality:120, morale:400, attack:16, power:24, defense:6,  armor:18, intimidation:8,  speed:5, range:1, bonus:"+1 de puissance et d'intimidation lors d'une charge." },
  { id:'archer',         name:'Archer',         category:'Tireurs',    cost:600,  vitality:240, morale:240, attack:7,  power:6,  defense:4,  armor:4,  intimidation:2,  speed:3, range:3, bonus:"Attaque à 300m. L'unité attaquée ne fait pas de test de défense." },
  { id:'archer_elite',   name:"Archer d'Élite", category:'Tireurs',    cost:900,  vitality:200, morale:300, attack:8,  power:8,  defense:6,  armor:7,  intimidation:3,  speed:3, range:4, bonus:"Attaque à 400m. L'unité attaquée ne fait pas de test de défense." },
  { id:'batisseurs',     name:'Bâtisseurs',     category:'Chars',      cost:1000, vitality:150, morale:75,  attack:4,  power:5,  defense:4,  armor:8,  intimidation:1,  speed:4, range:1, bonus:"Pour 2 vitesse, peut construire une barrière, un cheval de frise, une échelle, un pont ou brûler une tuile inflammable adjacente." },
  { id:'char',           name:'Char',           category:'Chars',      cost:1600, vitality:100, morale:375, attack:18, power:32, defense:6,  armor:22, intimidation:10, speed:5, range:1, bonus:"Peut attaquer 2 unités simultanément si les 3 sont alignées. Traverse les unités lorsque c'est possible." },
];
